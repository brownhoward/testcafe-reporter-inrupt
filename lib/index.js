const report = require("./report"); //import report from "./report";
...
module.exports = function () {
  ...
  return {
    ...
    reportTestDone(name, testRunInfo) {
      ...
      let resultIcon = "";
      if (testRunInfo.errs.length > 0) resultIcon = ":red_circle:";else if (testRunInfo.warnings !== null && testRunInfo.warnings !== undefined && testRunInfo.warnings.length > 0) resultIcon = ":large_yellow_circle:";else resultIcon = ":large_green_circle:"; // Test Result

...
module.exports = function () {
  ...
  return {
    ...
    reportTaskStart(startTime, userAgents, testCount) {
      ...
      this.includeFooter = "TRUE" == envs("TESTCAFE_REPORT_INCLUDEFOOTER", "TRUE").toUpperCase(); // Slack

      this.toSlack = "TRUE" == envs("TESTCAFE_REPORT_TOSLACK", "false").toUpperCase(); // Create the new Report
